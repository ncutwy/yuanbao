...
from p4hdp.p4_pd_rpc.ttypes import *
...
#from common.p4hdp_port import *
#from common.p4hdp_route import *
#from common.p4hdp_user import *
#from common.p4hdp_protocol_identify import *
...
"""
class PppoeTest(pd_base_tests.ThriftInterfaceDataPlane):
	def __init__(self):
		pd_base_tests.ThriftInterfaceDataPlane.__init__(self, ["p4hdp"])
	...
	def runTest(self):
		...
		try:
			...
			verify_packet_prefix(self, exp_pkt, 1, 14)
		finally:
			...
			mdp_virtual_test_user_remove(self.client, sess_hdl, device)
			...
			mdp_virtual_test_route_remove(self.client, sess_hdl, device)
			...
			mdp_virtual_test_intf_remove(self.client, sess_hdl, device)
...
class SnapshotEgL3Ipv4Test(pd_base_tests.ThriftInterfaceDataPlane):
	...
	def runTest(self):
		...
		try:
			...
			trig_spec = dc_snapshot_trig_spec_t("ipv4_srcAddr", ipv4Addr_to_i32("10.10.10.1"), 0)
			self.client.snapshot_capture_trigger_set(snap_hdl, trig_spec, trig_spec)
